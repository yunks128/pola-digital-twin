...
app.get('/config.js', (req, res) => {
    ...
    const mapsKey = process.env.GOOGLE_MAPS_API || 'YOUR_GOOGLE_MAPS_API_KEY';
    const configContent = `
...
app.listen(port, () => {
    ...
    console.log(`🗺️ Google Maps API Key: ${process.env.GOOGLE_MAPS_API ? 'configured' : 'not configured'}`);
    console.log('');
    console.log('To configure API keys:');
    console.log('export GEMINI_API_KEY="your_gemini_key_here"');
    console.log('export GOOGLE_MAPS_API="your_maps_key_here"');
